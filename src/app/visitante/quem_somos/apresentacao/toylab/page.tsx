...
export default function ToyLabPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F7F7]">
      ...
      <aside className="fixed top-14 left-0 h-[calc(100vh-56px)] w-44 bg-[#4C7F16] text-white p-4">
        <nav>
          <button type="button" onClick={() => setDimsOpen((v) => !v)} className="inline-flex items-center justify-between w-full gap-2 bg-[#355e0f] px-3 py-2 rounded-md shadow-sm text-white" aria-expanded={dimsOpen} aria-controls="dimensoes-list">
          ...
          {dimsOpen && (
            <ul id="dimensoes-list" className="mt-3 space-y-2">
              <li><Link href="/visitante/quem_somos/apresentacao/embrapii" className="block px-2 py-1 rounded hover:bg-white/10">Embrapii</Link></li>
              <li><Link href="/visitante/quem_somos/apresentacao/intap" className="block px-2 py-1 rounded hover:bg-white/10">InTap</Link></li>
              <li><Link href="/visitante/quem_somos/apresentacao/toylab" className="block px-2 py-1 rounded bg-white/10">ToyLab</Link></li>
              <li><Link href="/visitante/quem_somos/apresentacao/labcria" className="block px-2 py-1 rounded hover:bg-white/10">LabCria</Link></li>
              <li><Link href="/visitante/quem_somos/apresentacao/piape" className="block px-2 py-1 rounded hover:bg-white/10">PIAPE</Link></li>
            </ul>
          )}
        </nav>
      </aside>
