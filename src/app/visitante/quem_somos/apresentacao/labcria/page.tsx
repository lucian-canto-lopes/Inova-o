        ...
        <nav>
          ...
          {dimsOpen && (
            <ul id="dimensoes-list" className="mt-3 space-y-2">
              ...
              <li>
                <Link href="/visitante/quem_somos/apresentacao/labcria" className="block px-2 py-1 rounded bg-white/10">
                  LabCria
                </Link>
              </li>
              <li>
                <Link href="/visitante/quem_somos/apresentacao/piape" className="block px-2 py-1 rounded hover:bg-white/10">
                  PIAPE
                </Link>
              </li>
            </ul>
