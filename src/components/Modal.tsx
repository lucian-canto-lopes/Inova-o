...
export function Modal({
  ...
  const [subModalValue, setSubModalValue] = useState<any>({});
      ...
      case 'disciplinas':
        return (
          <>
            ...
            <button className="submodal-btn" onClick={() => setSubModalOpen(true)}><span>Editais</span><FaList /></button>
          </>
        )
      case "eventos":
        return (
      ...
      case "motores":
        return (
          <>
            ...
            <button className="submodal-btn" onClick={() => setSubModalOpen(true)}><span>Projetos</span><FaList /></button>
          </>
        )
      default:
  ...
  return (
    <section className="modal-bg">
      ...
      {isSubModalOpen && (
        <SubModal setValue={(value: any) => setSubModalValue(value)} closeSubModal={() => setSubModalOpen(false)} dimensao={modalType} />
      )}
    </section>
  )
}